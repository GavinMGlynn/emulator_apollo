...
| 68030 published timings (§11.6) | 19 register-form rows transcribed, the pure-microcode ones; the four divides carry the manual's data-dependent marker and are `PROVISIONAL`. Not yet wired into the step | `timing_table_suite`, 7 tests |
