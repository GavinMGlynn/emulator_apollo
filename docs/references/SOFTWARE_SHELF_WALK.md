...
below said "one document, `[CFG]`", and before that "Eight", then "seven"; the
paragraph under it is kept as it stood.*
...
2. ~~`AEGIS_Internals_and_Data_Structures`~~, 426 pages — **walked whole, 2026-09-15**
   (the rest of this entry is as it stood while it was **in progress**),
