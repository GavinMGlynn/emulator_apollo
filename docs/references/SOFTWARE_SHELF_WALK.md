...
| **in progress** | 0 | *`[CFG]` moved to read on its own terms 2026-09-15; this row said:* `[CFG]` — model description blocks and the July 1990 quick reference read 2026-09-15; option pages, Series 10000 and the upgrade matrices owed. *Corrected 2026-09-15: this row said 6 — "both GPIO editions, `018901-A00`, `[CFG]`, `000792-A01`, `Apollo_Price_List`" — and five of them had records saying nothing was owed; the register had not been updated when they finished* |
