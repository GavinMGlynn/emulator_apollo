...
| Class | Count | Basis |
| --- | --- | --- |
| **walked whole** | 8 | every page read — `004977-02`, both 1981 architecture papers, **`008860-A03` (295/295)** and **`002398-03` (260/260)**, both finished 2026-09-13, **`002398-01` Rev 1 (215/215, every page as an image, 2026-09-15)**, **`000959-A00` (314/314)**, and **`014962-A00` (157/157, every chapter read in full, 2026-09-15)**. *Corrected 2026-09-15: this row counted 10, including `008862-01`, `014962-A00` and `AEGIS_Internals`, whose own records say "passed over" with the rest condensed and full reads owed* |
...
| **in progress** | 2 | passed over in full, key chapters read whole, the rest condensed and owed by their own records — `008862-01` (Appendix F and §1.4 whole), `AEGIS_Internals` (7 chapters and Appendix A whole; 22 chapters, Appendix B's figures and the bound-in *Memory Organization and Management* owed). *`014962-A00` finished 2026-09-15; this row said 3* |
