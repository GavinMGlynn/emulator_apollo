...
- [ ] **Chapter 12, DN3000 — first, and the reason is scope.** Chapters 7–11 are
      ...
      **programmable interrupt controller**, **ring**, **SIO** and **timers**.
      ...
      has been read whole.
- [ ] **Chapters 1–6, machine-independent. Chapter 1 is under way: sixteen of its
      twenty-three pages read (PDF 12–25 contiguously, plus 28 and 31 out of
      order), the rest owed, resume at PDF 26.** The sample yielded no code change — chapter 1 is AEGIS's own
